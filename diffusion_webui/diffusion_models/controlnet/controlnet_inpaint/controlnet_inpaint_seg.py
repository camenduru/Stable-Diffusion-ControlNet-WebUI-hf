        ...
        with gr.Blocks():
            with gr.Row():
                with gr.Column():
                    ...
                    with gr.Row():
                        with gr.Column():
                            controlnet_seg_inpaint_stable_model_id = gr.Dropdown(
                            ...
                            controlnet_seg_inpaint_num_inference_step = gr.Slider(
                                minimum=1,
                                maximum=100,
                                step=1,
                                value=50,
                            ...
                            controlnet_seg_inpaint_num_images_per_prompt = gr.Slider(
                                minimum=1,
                                maximum=4,
                                step=1,
                                value=1,
                        ...
                        with gr.Row():
                            with gr.Column():
                                ...
                                controlnet_seg_inpaint_seed_generator = gr.Slider(
                                    minimum=0,
                                    maximum=1000000,
                                    step=1,
                                    value=0,
