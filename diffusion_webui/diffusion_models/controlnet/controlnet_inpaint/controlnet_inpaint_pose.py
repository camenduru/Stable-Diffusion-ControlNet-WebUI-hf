        ...
        with gr.Blocks():
            with gr.Row():
                with gr.Column():
                    ...
                    with gr.Row():
                        with gr.Column():
                            controlnet_pose_inpaint_stable_model_id = gr.Dropdown(
                            ...
                            controlnet_pose_inpaint_num_inference_step = gr.Slider(
                                minimum=1,
                                maximum=100,
                                step=1,
                                value=50,
                            ...
                            controlnet_pose_inpaint_num_images_per_prompt = gr.Slider(
                                minimum=1,
                                maximum=4,
                                step=1,
                                value=1,
                        ...
                        with gr.Row():
                            with gr.Column():
                                ...
                                controlnet_pose_inpaint_seed_generator = gr.Number(
                                    value=-1,
